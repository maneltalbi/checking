...
namespace CheckingSystem.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(CheckingSystemDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCat,Name,Description")] Categories categories)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCat,Name,Description")] Categories categories)
        {
